...
function DocumentTypeSelector({ documentType = [], documentTypeList = [], setDocumentType }) {
  const initialHeight = 30;
  const [selectHeight, setSelectHeight] = useState(initialHeight);

  const safeEmployeeRolesList = Array.isArray(documentTypeList) ? documentTypeList : [];
...
DocumentTypeSelector.propTypes = {
  ...
  documentTypeList: PropTypes.arrayOf(PropTypes.string),
