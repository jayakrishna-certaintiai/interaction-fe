...
function TeamMemberSelector({ teamName = [], teamNameList = [], setTeamName }) {
    const initialHeight = 30;
    const [selectHeight, setSelectHeight] = useState(initialHeight);

    const safeEmployeeRolesList = Array.isArray(teamNameList) ? teamNameList : [];
...
TeamMemberSelector.propTypes = {
    ...
    teamNameList: PropTypes.arrayOf(PropTypes.string),
