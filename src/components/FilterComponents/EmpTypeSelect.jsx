...
function EmpTypeSelect({ employementTypes = [], employementTypesList, setEmployementTypes }) {
    ...
    return (
        ...
        >
            ...
            >
                {employementTypesList?.map((phone) => (
