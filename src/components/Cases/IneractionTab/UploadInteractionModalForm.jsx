...
const UploadInteractionModalForm = ({
    open,
    handleClose,
    handleFormSubmit,
    type,
    ...
    return (
        ...
        >
            <Paper sx={styles.paperStyle}>
                <Typography variant="h6" sx={styles.titleStyle}>Upload Interaction</Typography>
                <Box
                ...
                >
                    ...
                    >
                        ...
                        <Typography sx={{ color: "#9F9F9F" }}>(Drag and drop your files)</Typography>
                        {fileNames.length > 0 && (
                            <Box
                                sx={{
                                    display: "flex",
...
export default UploadInteractionModalForm;
