...
const ProjectDownDataModal = ({ projects, handleSelectSummary, handleSelectAllSummary, updatePurpose, getFilteredSummary }) => {
    const [search, setSearch] = useState("");
    const [filteredSummary, setFilteredSummary] = useState([]);
    const [selected, setSelected] = useState([]);
    const [selectedAllProjectes, setSelectedAllSummary] = useState([]);
            ...
            <Box sx={{ px: 2 }}>
                <TableContainer sx={{ height: 300 }} >
                    <Table stickyHeader aria-label="simple table">
                        ...
                        <TableBody>
                            {newFilteredSummary?.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage)?.map((row, index) => {
                                const newRow = {};
...
export default ProjectDownDataModal;