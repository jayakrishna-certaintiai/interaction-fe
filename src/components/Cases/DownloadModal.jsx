...
const DownloadModal = ({ open, usedfor, handleClose, updatePurpose, projects, postUpdate, }) => {
                    ...
                    <form>
                        <Box sx={{ height: "90%" }}>
                            <DownloadDataModal
                                ...
                                handleSelectAllSummary={handleSelectAllSummary}
                                updatePurpose={updatePurpose}
                                getFilteredSummary={getFilteredSummary}
                                documentType={documentType}
                            />
                            {summaryError && (<Typography color="error" sx={{ mt: 1 }}>{summaryError}</Typography>)}
                        </Box>
