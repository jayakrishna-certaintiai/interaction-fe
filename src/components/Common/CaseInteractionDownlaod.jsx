...
import InteractionDownDataModal from './InteractionDownDataModal';
...
const CaseInteractionDownlaod = ({ open, usedfor, handleClose, updatePurpose, projects, postUpdate, }) => {
        ...
        >
            <Paper sx={styles.paperStyle}>
                <Box sx={{ ...styles.box1Style, py: 1, }}>
                    ...
                    <form>
                        <Box sx={{ height: "90%" }}>
                            <InteractionDownDataModal
                                projects={projects}
                                handleSelectInteraction={handleSelectInteraction}
                                handleSelectAllInteraction={handleSelectAllInteraction}
                                updatePurpose={updatePurpose}
                                getFilteredInteraction={getFilteredInteraction}
                                documentType={documentType}
                            />
                            {InteractionError && (<Typography color="error" sx={{ mt: 1 }}>{InteractionError}</Typography>)}
                        </Box>
...
export default CaseInteractionDownlaod
