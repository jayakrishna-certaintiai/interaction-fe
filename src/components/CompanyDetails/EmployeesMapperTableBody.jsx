...
const EmployeesMapperTableBody = ({ editMode, addEmployeesFormik, employeesMapperData = [] }) => {
    let [rows, setRows] = useState([]);

    useEffect(() => {
        if (employeesMapperData) {
            setRows([...employeesMapperData]);
        }
    }, [employeesMapperData])
                            ...
                            {editMode ? (
                                <InputBox
                                    ...
                                    onChange={(e) => {
                                        ...
                                        addEmployeesFormik.setFieldValue('rows', updatedRows);
                                    }}
                                    sx={{ mx: "0" }}
                                />
                            ) : (
...
export default EmployeesMapperTableBody;
